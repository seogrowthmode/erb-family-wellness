...
export const metadata: Metadata = {
  title: "About Dr. David Erb - Chiropractor Coppell TX",
  description:
    "Meet Dr. David & Dr. Kimberly Erb — 2012 Olympic chiropractors in Coppell, TX. 28 years of corrective care. (972) 393-6262.",
};
